...
\programming{{$\textbullet$Bash $\textbullet$NodeJS $\textbullet$ ReactJS $\textbullet$Solidity  / Basic}, { $\textbullet$C  $\textbullet$Matlab  $\textbullet$HTML  $\textbullet$MySQL  / Intermediate}, { $\textbullet$C++ $\textbullet$Python  / Advanced}}
