...
\programming{{$\textbullet$Bash $\textbullet$JS  / Basic}, {$\textbullet$Python $\textbullet$C  $\textbullet$Matlab  $\textbullet$HTML  $\textbullet$CSS  / Intermediate}, { $\textbullet$C++   / Advanced}}
 
\lang{{$\textbullet$German(A1)  / Basic}, {$\textbullet$English $\textbullet$Hindi/ Fluent}, { $\textbullet$Nepali / Native}}
...
\cvmail{rohitpaudel9@gmail.com} % Email address
