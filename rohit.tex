...
\programming{{$\textbullet$Bash $\textbullet$JS  / Basic}, {$\textbullet$Python $\textbullet$Java  $\textbullet$Lua     $\textbullet$C  $\textbullet$Matlab  / Intermediate}, { $\textbullet$C++   / Advanced}}
